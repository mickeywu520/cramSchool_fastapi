...
class Student(Base):
    ...
    parent_title: Mapped[str | None] = mapped_column(String(10), nullable=True)
    phone: Mapped[str] = mapped_column(String(20), nullable=False)
    parent2_name: Mapped[str | None] = mapped_column(String(50), nullable=True)
    parent2_title: Mapped[str | None] = mapped_column(String(10), nullable=True)
