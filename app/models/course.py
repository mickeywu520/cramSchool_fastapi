...
class Course(Base):
    ...
    tutoring_day_of_week: Mapped[int | None] = mapped_column(Integer, nullable=True)
    tutoring_days_of_week: Mapped[str | None] = mapped_column(String(20), nullable=True)
    tutoring_start_time: Mapped[str | None] = mapped_column(String(10), nullable=True)
    tutoring_end_time: Mapped[str | None] = mapped_column(String(10), nullable=True)
    tutoring_location: Mapped[str | None] = mapped_column(String(50), nullable=True)
    ...
    is_early_bird: Mapped[bool] = mapped_column(Boolean, default=False)
    early_bird_discount: Mapped[str | None] = mapped_column(Text, nullable=True)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True)
    is_teaching: Mapped[bool] = mapped_column(Boolean, default=True)
